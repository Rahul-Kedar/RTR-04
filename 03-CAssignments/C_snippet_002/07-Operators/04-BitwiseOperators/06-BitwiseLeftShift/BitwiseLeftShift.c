...
int main(void)
{
    ...
    printf("\n\n");
    printf("By How Many Bits Do You Want To Shift a_RAK = %d To The Left ? ", a_RAK);
    scanf("%u", &num_bits_RAK);

    printf("\n\n\n\n");
    result_RAK = a_RAK << num_bits_RAK;
    printf("Bitwise LEFT-SHIFTing By %d Bits Of a_RAK = %d \nGives The Result = %d (Decimal).\n\n", num_bits_RAK, a_RAK, result_RAK);
