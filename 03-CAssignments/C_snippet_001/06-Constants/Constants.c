...
#define MY_PI_RAK 3.1415926535897932

#define AMC_STRING_RAK "AstroMediComp RTR"
...
int main(void)
{
    ...
    printf("MY_PI_RAK Macro Value = %.10lf\n\n", MY_PI_RAK);
    printf("Area Of Circle Of Radius 3 units = %f\n\n", (MY_PI_RAK * 3.0f * 3.0f));

    printf("\n\n");

    printf(AMC_STRING_RAK);
    printf("\n\n");

    printf("AMC_STRING_RAK is : %s\n", AMC_STRING_RAK);
    printf("\n\n");
